...
public class StructureCreator : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (PlayerCellPosition().magnitude > lastPlayerCellPosition.magnitude + 20)
        {
            ...
            Generator.GenerateCrossGrid(randomX,randomY,randomCenterOnRange,randomSize,randomOffsetX,randomOffsetY, tilemap, seed, amplitude, lacunarity, tileSet, isAdditive, true);
        ...
        Generator.GenerateCrossGrid(randomX, randomY, randomCenterOnRange, randomSize, randomOffsetX, randomOffsetY, tilemap, seed, amplitude, lacunarity, tileSet, isAdditive, false);
    }
